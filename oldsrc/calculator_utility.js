Calculator.service('CalculatorUtil', function (MathTerm, MathOperation, MathBracketed, MathProbability, Orderer, Logger) {

    this.mathtypes = {};

    this.setMathtypes = function(types) {
        this.mathtypes = types;
    };
