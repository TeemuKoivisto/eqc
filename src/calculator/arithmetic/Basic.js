...
class Basic extends Calculator {
  ...
  sumOperationAndTerm(Augent, Addend) {
    throw ("unsupported sum operation and term");
  }

  sumTermAndBracketed(Augent, Addend) {
    throw ("unsupported sum term and bracketed");
  }

  sumTermAndOperation(Augent, Addend) {
  ...
  multiplyAndReplace(Location, Operation) {
  ...
  multiplyBracketedAndBracketed(Multiplicand, Multiplier) {
  ...
  multiplyBracketedAndOperation(Multiplicand, Multiplier) {
  ...
  multiplyBracketedAndTerm(Multiplicand, Multiplier) {
  ...
  multiplyOperationAndBracketed(Multiplicand, Multiplier) {
    throw ("unsupported multiply operation and bracketed");
    // reverse to bracketed and operation
  }

  multiplyOperationAndOperation(Multiplicand, Multiplier) {
  ...
  multiplyOperationAndTerm(Multiplicand, Multiplier) {
  ...
  multiplyTermAndBracketed(Multiplicand, Multiplier) {
  ...
  multiplyTermAndOperation(Multiplicand, Multiplier) {
    throw ("unsupported multiply term and operation");
  }

  multiplyTermAndTerm(Multiplicand, Multiplier) {
  ...
  divideAndReplace(Location, Operation) {
  ...
  // what of primes?
  greatestCommonFactor(First, Second) {
  ...
  simplifyFractionTerms(Numerator, Denominator) {
  ...
  equalDenominators(First, Second) {
  ...
  divideBracketedAndBracketed(Numerator, Denominator) {
  ...
  divideBracketedAndOperation(Numerator, Denominator) {
    throw ("unsupported divide bracketed and operation");
  }

  divideBracketedAndTerm(Numerator, Denominator) {
  ...
  divideOperationAndBracketed(Numerator, Denominator) {
    throw ("unsupported divide operation and bracketed");
  }

  divideOperationAndOperation(Numerator, Denominator) {
  ...
  // 1/6/6
  divideOperationAndTerm(Numerator, Denominator) {
  ...
  divideTermAndBracketed(Numerator, Denominator) {
  ...
  divideTermAndOperation(Numerator, Denominator) {
    throw ("unsupported division of term with operation");
  };

  divideTermAndTerm(Numerator, Denominator) {
